...
At this momment with postgresql 9.3 as last stable version it has very limited set
of native operators for json type (with 9.4 much other operators will added).
...
NOTE: when postgresql 9.4 is released, more lookups will be added.
